class Student:
    ...
    def RunningAverage(self):
        ...
        return sum(non_blank_scores) / len(non_blank_scores) if non_blank_scores else 0
...
# Assuming StudentScores.txt is in the same directory and has the required format
